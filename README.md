...
- v0.6.3 ✅ Review picker restructured to two dropdowns (Timeframe × Period); "Specific" support extended to week/month/quarter/year (anchor-driven reviews); textarea-focus bug fixed (no re-render on input); AI-summary box ~30% shorter; review textarea reasonably sized; built-in edit shows "edited" badge + clear "Reset to default" button + explanatory note
